...
experiments = [
    ...
    ("cs336_basics/configs/sweep_lr100.yaml", "Lr100"),
    ("cs336_basics/configs/sweep_lr50.yaml", "Lr50"),
    # Add more experiments here...
]


def run_experiment(config_file, experiment_name):
    cmd = ["uv", "run", "cs336_basics/train_model.py", "--config", config_file, "--experiment_name", experiment_name]
